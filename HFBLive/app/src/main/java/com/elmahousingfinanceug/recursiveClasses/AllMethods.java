...
import com.elmahousingfinanceug.launch.rao.AccountOpenZMain;
import com.elmahousingfinanceug.main_Pages.ATM_Locations;
import com.elmahousingfinanceug.main_Pages.About_Us;
import com.elmahousingfinanceug.main_Pages.Branches_Page;
import com.elmahousingfinanceug.main_Pages.Contact_Us;
import com.elmahousingfinanceug.main_Pages.Profile;
import com.elmahousingfinanceug.main_Pages.ZAtmBranch;
...
public class AllMethods {
    ...
    public void Drawer_Item_Clicked(Context context, int id) {
        if (id == R.id.myProfile) {
            ...
            context.startActivity(new Intent(context, com.elmahousingfinanceug.main_Pages.Settings.class));
...
//                                        Log.e("RAO-PRO",jsonObject.toString()) ;
        ...
        LogThis("NIMECHOKA"+jsonObject.toString());
    }
    ...
    private void connect (String request, String baseUrl, final String result, final ResponseListener responseListener, final String token, final String step){
        ...
        LogThis("GETPRODUCTSREQ"+ REVERSE(request,""));
    }
    ...
    private void RAOApiCall(String request, String BaseUrl, String machine, final ResponseListener responseListener, final String Token, String step) {
        ...
        LogThis("RAOREQ ► " + decryptOldApp(request) );
