...
import com.elmahousingfinanceug_test.main_Pages.CopyPage;
...
public class RecreateKey_Send extends AppCompatActivity implements ResponseListener, VolleyResponse {
    ...
    TextView continue1, account_opening, contactBank;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contactBank = findViewById(R.id.contactBank);
        ...
        continue1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (eTPhone.getText().toString().trim().length() < 5) {
                    am.myDialog(RecreateKey_Send.this,getString(R.string.alert),getString(R.string.invalidMobileNumber));
                } else if (!bank.isChecked() && !sendMe.isChecked()) {
                    am.myDialog(RecreateKey_Send.this,getString(R.string.alert),getString(R.string.select1Option));
                } else if (bank.isChecked() && eTKey.getText().toString().trim().length() < 6) {
                    am.myDialog(RecreateKey_Send.this,getString(R.string.alert),getString(R.string.invalidRKey));
                } else if (sendMe.isChecked() && eTPin.getText().toString().trim().length() < 4) {
                    am.myDialog(RecreateKey_Send.this,getString(R.string.alert),getString(R.string.invalidPin));
                } else {
        ...
        account_opening.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RecreateKey_Send.this, AccountOpenSplash.class));
            }
        });

        contactBank.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RecreateKey_Send.this, Contact_Us.class));
//                startActivity(new Intent(RecreateKey_Send.this, CopyPage.class));
            }
        });
    }
