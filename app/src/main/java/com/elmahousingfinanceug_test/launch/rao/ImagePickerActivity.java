...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private int IMAGE_COMPRESSION = 40;
    ...
    private Uri getCacheImagePath(String fileName) {
        ...
        // TODO: 1/28/2022 shouild match with privider in Manifest
...
//            Toast.makeText(context, "Cache not found to delete", Toast.LENGTH_SHORT).show();
            ...
            if (path.exists() && path.isDirectory()) {
                ...
                //Toast.makeText(context, "Dir not found to delete", Toast.LENGTH_LONG).show();
            }
        }
    }
}
