    ...
    public void onCreate() {
        ...
        OkHttpClient okHttpClient = new OkHttpClient()
                ...
                .certificatePinner(new CertificatePinner.Builder()
                        .add("uat.craftsilicon.com","sha256/KkxMRmNcFnqSYMct1SPLHsergwCXey3adt7a7qQyYPU=")
                        .add("uat.craftsilicon.com","sha256/RRM1dGqnDFsCJXBTHky16vi1obOlCgFFn/yOhI/y+ho=")
                        .add("uat.craftsilicon.com","sha256/WoiWRyIOVNa9ihaBciRSC7XHjliYS9VwUGOIud4PB18=")
                        .build())
